...
import com.web.util.AjaxUtils;
import com.web.util.PortalConstant;
 ...
 * @copyRight 亚信电信EC研发部
 */
public class CsrfPreventionFilter extends OncePerRequestFilter implements Serializable {

	private static final long serialVersionUID = 7161150631195499792L;

	private static Logger log = LoggerFactory.getLogger(CsrfPreventionFilter.class);
    ...
    public static void main(String[] args) {
        Perl5Util matcher = new Perl5Util();
        String entryPoint = "/^/staff/login/(?!(page|logout)\\b).*$/";
        String path = "/staff/login/page";
          System.err.println(matcher.match(entryPoint, path));
        entryPoint = "^/main/(?!(home)\\b).*$";
        path = "/main/home";
    }
}
